# UCB in PyTorch implemntation with SVHN and USPS Datasets
...
```
- To run experiments on new datasets use `src/runnew.py --experiment <name>` where `name` can be [`svhn2`,`svhn5`,`usps2`,`usps5`].
